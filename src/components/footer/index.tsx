    ...
    >
      <div className="flex flex-col gap-[21px] w-full lg:w-[30%]">
        ...
        <p className="text-[#939393]">
          We are a travel company that provides the most exciting domestic and
          international tours in Pakistan. our trips include tours to hunza ,
          skardu , swat and kashmir among other places
        </p>
      </div>
      ...
      <ul className="flex flex-col gap-[21px] w-full lg:w-1/6">
        ...
        <li className="flex gap-2 items-start  ">
          ...
          />
          <p>
            Wallayat Complex, 0ffice no. 13 Sadat Arcade, Bahria Expy, Phase 7
            Islamabad
          </p>
        </li>
      </ul>
  ...
  return (
    <div className="w-full h-[70px] lg:h-[90px] px-[1%] lg:px-[10%] py-2 lg:py-0 flex flex-col lg:flex-row  justify-between items-center bg-black text-white">
      <p className="text-[#B1B1B1] text-[12px] lg:text-[14px]">
        ©2024 Copyright Baydar Travels Pvt Ltd. All rights reserved
      </p>
